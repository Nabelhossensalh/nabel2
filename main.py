...
class AppUI:
    def __init__(self, page: ft.Page):
        ...
        # تحديد مسار التخزين المناسب للمنصة (أندرويد أو كمبيوتر)
        storage_path = ""
        if hasattr(self.page, 'client_storage') and self.page.web:
            storage_path = ""
        else:
            try:
                env_path = os.environ.get('FLET_APP_STORAGE_DATA', '')
                if env_path:
        ...
        # إعدادات الصفحة
        self.page.title = "نظام بقالة ذكية     | POS"
        self.page.bgcolor = "#F4F7FC"
        self.page.rtl = True
        self.page.theme_mode = ft.ThemeMode.LIGHT
        self.page.theme = ft.Theme(font_family="Cairo")

        # تعيين حجم النافذة فقط على الكمبيوتر (يتجاهل على أندرويد)
        try:
            ...
            ft.Container(
                ...
                content=ft.Column(
                    [
                        ...
                        ft.Text("نظام البقالة الذكي", size=32, color="white", weight="bold", text_align="center"),
